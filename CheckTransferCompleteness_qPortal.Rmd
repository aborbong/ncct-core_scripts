...
checkup_transfer = function(qportal_report_filepath, demultiplexed_files_filepath,transfer_date) {
  ...
  if(length(missing_samples)==0){
    message("✅  All samples for transfer date ",transfer_date," are present in the qPortal")}
  else{
    message("⚠️  The following samples are missing in the qPortal for transfer date",transfer_date,":")
